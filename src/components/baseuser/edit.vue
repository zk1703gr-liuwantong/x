<template>
	<div style='text-align: center;'>
		...
		<el-row>
		  ...
		  <el-col :span="12"> <el-input style='width:300px;margin-top: 20px;' placeholder='联系电话' v-model='telno'></el-input> </el-col>
		</el-row>
		<el-row>
		...
		<el-row>
		  ...
		  <el-col :span="12"> <el-input style='width:300px;margin-top: 20px;' placeholder='id' v-model='userid'></el-input> </el-col>
		</el-row>
