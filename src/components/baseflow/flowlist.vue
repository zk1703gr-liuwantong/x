	...
	<div>
		...
		<center>
			<el-table :data="list">
				...
				<el-table-column prop="flowname" label="公司名称" width="120"></el-table-column>
				<el-table-column prop="compname" label="联系人" width="120"></el-table-column>
				<el-table-column prop="dljname" label="联系电话" width="120"></el-table-column>
				<el-table-column prop="zcjname" label="行业" width="180"></el-table-column>
				<el-table-column prop="pdjname" label="地址" width="180"></el-table-column>
...
<script>
	export default {
		...
		methods:{
			update(row){
				// 跳转
				// this.$router.push({name:'CompList',params:{row:row}})
			},
			del(compid){
				// 后端网址
