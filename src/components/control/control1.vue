		...
		<div style="display: inline-block;width: 800px;margin: 10px 0 0 20px;
			...
			<div style="font-size: 14px;color: #606266;">
				...
				<el-row style='margin-top: 20px;'>
				  <el-col :span="6" >
					  <el-select  placeholder="请选择流程"  v-model='flowid' style='width: 150px;' >
				...
				<el-row style='margin-top: 20px;'>
				  ...
				  <el-col :span="6">
					<el-button type='primary'  :disabled="startButtonFlag">开始作业</el-button>
				  </el-col>
				  <el-col :span="6">			
				  ...
				  <el-col :span="6">
					<el-button type='success'  :disabled='completeButtonFlag'>结束作业</el-button>
				  </el-col>
				</el-row>
				<div class="boat">
					<div class="wrap">
		...
		methods:{
			sc1(){
				...
				this.$axios.post(url,{
					...
					this.reportuser=s.reportuser;
					this.planjobtime=s.planjobtime;
