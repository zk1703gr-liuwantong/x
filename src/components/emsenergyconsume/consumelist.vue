...
<template>
	<div>
		...
		<center>
			<el-table :data="list">
				<el-table-column prop="consumeid" label="主键能耗id" width="80"></el-table-column>
				<el-table-column prop="devname" label="设备名称" width="120"></el-table-column>
				<el-table-column prop="electric" label="电耗" width="120"></el-table-column>
				<el-table-column prop="water" label="水耗" width="120"></el-table-column>
				<el-table-column prop="oil" label="油耗" width="180"></el-table-column>
...
<script>
	export default {
		...
		methods:{
			...
			del(compid){
				// 后端网址
				var url = this.baseUrl+"/emsenergyConsume/delete"
				// 传递给后端的数据
				
				var data = {consumeid:compid};
