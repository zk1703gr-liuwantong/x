<template>
	<div style='text-align: center;'>
		...
		<el-row>
		  ...
		  <el-select v-model="devname" placeholder="请选择"  style='width:300px;margin-top: 20px;'>
		   	<el-option
		   	  v-for="item in list1"
		   	  :label="item.typename"
		   	  :value="item.typeid">
		...
		<el-row>
		  <el-col :span="12"> <el-input style='width:300px;margin-top: 20px;' placeholder='设备类别' v-model='typeid'></el-input> </el-col>
	...
	export default {
		...
		methods:{
			saveAdd(){
				...
				// 传递给后端的数据
				var data = {devname:this.devname,typeid:this.typeid,devdata:this.devdata,devuser:this.devuser,compid:this.compid};
